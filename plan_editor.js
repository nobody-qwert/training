...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM content loaded, initializing workout planner');
...
// Function to initialize the planner after ensuring dependencies are loaded
function initializePlanner() {
    ...
    // Load default plan if no shared plan is loaded by share_plan.js
    // This will be overridden if a shared plan is loaded
    console.log('Loading default plan');
